...
import 'package:sheria_pocket/screens/detail_shopping.dart';
...
class ShoppingCards extends StatefulWidget {
  ...
  final String name, location, imageUrl, price;
  final int id;
                  ...
                  child: FlatButton(
                      onPressed: () {
                        ...
                        Navigator.push(context, MaterialPageRoute(builder: (_) {
                          return DetailShopping(id: widget.id);
                        }));
                      },
                      color: darkBlueColor,
                      shape: RoundedRectangleBorder(
