...
class BookLawyerList extends StatefulWidget{
  ...
  BookLawyerList({Key key, @required this.url, @required this.name, @required this.specialist, @required this.booked}) : super(key : key);
          ...
          Wrap(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  TextWidget(text: widget.name, color: Colors.black, font: 'Poppins-Regular', fontSize: 12),
                  TextWidget(text: widget.specialist, color: Colors.black54, font: 'Poppins-Light', fontSize: 12),
                ],
